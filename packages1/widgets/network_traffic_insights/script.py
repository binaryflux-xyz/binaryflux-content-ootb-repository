...
def configure():
    return {
        ...
        "dimension": {"x":0,"y":3,"width": 7, "height": 3}
    }
...
def render(results):
    ...
    return  {"series":[{"keys": columns, "data": categories}],"column":"source_ip","label":"Sourceip","uniquekey":["from","to"],"columnmap":["source_ip","destination_ip"],"type":"source_destination_data_transfer"}
