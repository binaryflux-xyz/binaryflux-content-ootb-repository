...
def query():
    return {
        "query": "select host_name as name,log_syslog_hostip as hip,count(*) as weight from aggregation_table  where host_name is not null and log_syslog_hostip is not null and type = :type group by host_name,log_syslog_hostip",
