...
def query():
    return {
        'query': 'select destination_country as name,count(*) as weight from aggregation_table  where destination_country is not null and type = :type group by destination_country',
        'parameters': {"type":"country_detection_map"}
    }
