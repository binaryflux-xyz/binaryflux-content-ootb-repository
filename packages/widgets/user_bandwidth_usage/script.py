...
def query():
    return {
        "query": """SELECT source_ip, SUM(network_bytes_transferred) as bytestransferred \
...
def render(results):
    ...
    return {"result": categories,"column":"source_ip","label":"Entity","uniquekey":['name'],"columnmap":["source_ip"]}
