...
def configure():
    return {
        ...
        "dimension": {"x":0,"y":13,"width": 6, "height": 4}
    }
...
def render(result):
  ...
  "Zimbabwe": "zw"
    ...
    return {"result": formatted_result,"column":"source_location","label":"Country","uniquekey":["name"],"columnmap":["source_location"],"type":"microsoft_top_location_event"}
