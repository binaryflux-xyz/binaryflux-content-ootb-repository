...
def query():
    return {
        ...
        "parameters": {"type":"event_severity_stats"},
    }
...
def render(result):
    ...
    return {"result":transformed_data,"column":"event_severity","label":"Event Severity","type":"event_severity_stats","uniquekey":["name"],"columnmap":["event_severity"]}
