...
def configure():
    return {
        ...
        "dimension": {"x":6,"y":11,"width": 6, "height": 3}
    }
...
def query():
    return {
        "query": "SELECT DATE(insert_date) AS insertdate, COUNT(score) AS value FROM entityscoring GROUP BY insertdate ORDER BY insertdate ASC",
        "parameters": {}
    }
